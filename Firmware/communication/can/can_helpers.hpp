...
struct can_Message_t {
    uint32_t id = 0x000;  ///< CAN message identifier (11-bit or 29-bit)
    bool isExt = false;   ///< Extended ID flag
    bool rtr = false;     ///< Remote Transmission Request flag
    uint8_t len = 8;      ///< Data Length Code (0-8)
    uint8_t buf[8] = {0, 0, 0, 0, 0, 0, 0, 0};  ///< Data payload
};

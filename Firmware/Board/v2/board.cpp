...
#define ControlLoop_IRQHandler SPI2_IRQHandler
#define ControlLoop_IRQn SPI2_IRQn
...
void start_timers() {
    CRITICAL_SECTION() {
        ...
        */
        ...
        hadc2.Instance->CR |= (ADC_EXTERNALTRIGCONVEDGE_RISING);
        hadc2.Instance->JSQR |= (ADC_EXTERNALTRIGINJECCONV_EDGE_RISING);
        hadc3.Instance->CR |= (ADC_EXTERNALTRIGCONVEDGE_RISING);

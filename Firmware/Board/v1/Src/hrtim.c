...
void MX_HRTIM1_Init(void)
{
  ...
  pADCTriggerCfg.Trigger = HRTIM_ADCTRIGGEREVENT13_TIMERA_PERIOD|HRTIM_ADCTRIGGEREVENT13_TIMERA_RESET;
  if (HAL_HRTIM_ADCTriggerConfig(&hhrtim1, HRTIM_ADCTRIGGER_1, &pADCTriggerCfg) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_HRTIM_ADCPostScalerConfig(&hhrtim1, HRTIM_ADCTRIGGER_1, HRTIM_REP) != HAL_OK)
  {
    Error_Handler();
  }
  pTimeBaseCfg.Period = HRTIM_PERIOD_CLOCKS * 2;
  pTimeBaseCfg.RepetitionCounter = HRTIM_REP;
  ...
  pDeadTimeCfg.RisingValue = HRTIM_DEADTIME_CLOCKS;
  pDeadTimeCfg.RisingSign = HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE;
  pDeadTimeCfg.RisingLock = HRTIM_TIMDEADTIME_RISINGLOCK_WRITE;
  pDeadTimeCfg.RisingSignLock = HRTIM_TIMDEADTIME_RISINGSIGNLOCK_READONLY;
  pDeadTimeCfg.FallingValue = HRTIM_DEADTIME_CLOCKS;
  ...
  pTimeBaseCfg.RepetitionCounter = 2 * (HRTIM_REP + 1);
  ...
  pTimeBaseCfg.Period = HRTIM_PERIOD_CLOCKS * (HRTIM_REP + 1);

...
public:
    ...
    struct Config_t {
        ...
        float calibration_current = 0.3f;    // [A]
        ...
        float phase_inductance = 0.000305f;        // to be set by measure_phase_inductance
        float phase_resistance = 0.735f;        // to be set by measure_phase_resistance
        float torque_constant = 0.0355f;         // [Nm/A] for PM motors, [Nm/A^2] for induction motors. Equal to 8.27/Kv of the motor

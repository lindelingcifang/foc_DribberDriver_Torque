...
struct ResistanceMeasurementControlLaw : AlphaBetaFrameController {
    ...
    ZfocIntf::MotorIntf::Error get_alpha_beta_output(
...
bool Motor::arm(PhaseControlLaw<3>* control_law) {
    ...
    CRITICAL_SECTION() {
        ...
        if (!zfoc.config_.enable_brake_resistor || brake_resistor_armed) {
            armed_state_ = 1;
            is_armed_ = true;
        } else {
...
// TODO: Nothing to check. Consider removing this method.
